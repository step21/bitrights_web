...
logging.cond = make_accessor(logging.COND, 150);
logging.fixd = make_accessor(logging.FIXED, 100);
logging.plac = make_accessor(logging.PLACE, 100);
